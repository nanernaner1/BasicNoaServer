...
class LMStudioProvider(ProviderBase):
    def send_request(self, chat_messages, temperature):
        ...
        try:
            ...
            print("Received response from LM Studio:", completion)
            ...
            return "Request to LM Studio timed out"
        except requests.exceptions.RequestException as e:
            print("Error while getting completion from LM Studio:", e)
            return "Failed to get response from LM Studio"
